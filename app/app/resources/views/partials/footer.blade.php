    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <a href="#intro" class="footer-brand">
            ...
            <div class="col-lg-3 col-md-4 mb-4 mb-md-0">
                ...
                <ul class="footer-links">
                    <li><a href="#services">{{ __('site.services.items.websites.title') }}</a></li>
                    <li><a href="#services">{{ __('site.services.items.ecommerce.title') }}</a></li>
                    <li><a href="#services">{{ __('site.services.items.webapps.title') }}</a></li>
                    <li><a href="#services">{{ __('site.services.items.seo.title') }}</a></li>
                </ul>
            </div>
